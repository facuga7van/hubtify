...
const api = {
  ...
  rpgGetShopCatalog: () => ipcRenderer.invoke('rpg:getShopCatalog'),
  rpgPurchaseShopItem: (itemId: string) => ipcRenderer.invoke('rpg:purchaseShopItem', itemId),
  rpgEquipShopItem: (itemId: string | null, kind?: string) => ipcRenderer.invoke('rpg:equipShopItem', itemId, kind),
  rpgGetMasteries: () => ipcRenderer.invoke('rpg:getMasteries'),
  ...
  cauldronLogPastSession: (payload: Record<string, unknown>) => ipcRenderer.invoke('cauldron:logPastSession', payload),
  ...
  financeGetAccounts: () => ipcRenderer.invoke('finance:getAccounts'),
  financeGetAccountsOverview: () => ipcRenderer.invoke('finance:getAccountsOverview'),
  financeSaveAccount: (input: Record<string, unknown>) => ipcRenderer.invoke('finance:saveAccount', input),
  financeDeleteAccount: (id: string) => ipcRenderer.invoke('finance:deleteAccount', id),
  financeTransferBetweenAccounts: (input: Record<string, unknown>) => ipcRenderer.invoke('finance:transferBetweenAccounts', input),
